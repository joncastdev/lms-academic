...
class QuestionSeeder extends Seeder
{
	public function run()
	{
		...
		$data = [
			[			
				'question' => 'CodeIgniter 4 es un framework basado en el lenguaje de programación?',				
				'id_exam' => 1,
				'id_amswer' => 1,									
			],
			[				
				'question' => 'Que versión de PHP es necesaria para poder trabajar con CodeIgniter 4?',				
				'id_exam' => 1,
				'id_amswer' => 4,								
			],
			[							
				'question' => 'Supongamos que creamos un controlador llamado Home, este debe extender de cual
controlador?',				
				'id_exam' => 1,
				'id_amswer' => 7,								
			],
