...
<?php echo $this->renderString('<link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/morris.js/0.5.1/morris.css">
...
<div class="row">
	...
	<div class="col-lg-12 mb-4">
		...
		<div class="card-body">
			...
			<!-- <h4><b>Welcome back:</b><?php //echo $first_name; ?></h4> -->
						...
						<div class="card shadow mb-4">
							...
							<div class="card-body" id="body">
								...
								<div class="box-header">
									...
									<h3 class="box-title">Statistics Users</h3>
		...
		<?php echo $this->renderString('<script src="//cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js"></script>') ?>
		<?php echo $this->renderString('<script src="//cdnjs.cloudflare.com/ajax/libs/morris.js/0.5.1/morris.min.js"></script>') ?>
		<?php echo $this->renderString('<script src="/assets/js/chart.js"></script>') ?>
